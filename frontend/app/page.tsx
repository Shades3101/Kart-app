...
export default function Home() {
  ...
  const blogPosts = [
    ...
    },
    {
      ...
      title: "What is Kart?",
      description:
        "Discover how Kart helps you buy and sell used books online easily.",
  ...
  const sellSteps = [
    {
      ...
      description:
        "Post an ad on Kart describing your book details to sell your old books online.",
  ...
  return <div className="min-h-screen">
    <section className="relative h-[600px] overflow-hidden">
      {bannerImages.map((image, index) => (
        <div key={index} className={`absolute inset-0 transition-opacity duration-1000 ${currentImage === index ? 'opacity-100' : 'opacity-0'}`}>
          ...
          <Image src={image} fill alt="banner" priority={index === 0} className="object-cover"></Image>
      ...
      <div className="relative container mx-auto px-4 h-full flex flex-col items-center justify-center text-white text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-6">
          <Button size="lg" className="group bg-linear-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white px-7 py-7 rounded-xl">
            <Link href="/books">
          ...
          <Button size="lg" className="group bg-linear-to-r from-yellow-500 to-yellow-600 hover:from-yellow-600 hover:to-yellow-700 text-white px-7 py-7 rounded-xl">
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-4">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            Are Your Old Books Rotting Away? Why not Sell them and Earn Some Extra Money in just 3 Simple Steps?
          </p>
        </div>
    ...
    <section className="py-16 bg-[rgb(221,234,254)] mt-5">
      <div className="container mx-auto px-4">
